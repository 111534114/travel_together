...
ACTION_LABELS = {  # 定義每種操作代碼對應的中文顯示名稱，給操作紀錄頁面用
    ...
    "import_restaurants_google": "從Google地圖匯入餐廳",
    "bulk_activate_restaurants": "批次啟用餐廳",
    "bulk_delete_restaurants": "批次刪除餐廳",
    "backfill_restaurant_descriptions": "批次補上餐廳描述",
    "create_accommodation": "新增住宿",
    "update_accommodation": "更新住宿",
    "delete_accommodation": "刪除住宿",
    "import_accommodations": "匯入住宿",
    "import_accommodations_google": "從Google地圖匯入住宿",
    "bulk_activate_accommodations": "批次啟用住宿",
    "bulk_delete_accommodations": "批次刪除住宿",
    "backfill_accommodation_descriptions": "批次補上住宿描述",
    "create_country": "新增國家",
    "update_country": "更新國家",
    "delete_country": "刪除國家",
    "create_city": "新增城市",
